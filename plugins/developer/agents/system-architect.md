---
# DUPLICATE: a copy of this file lives at
# plugins/product-marketing/agents/system-architect.md (so the orchestrator can
# reach it when the developer plugin is off). Keep both copies in sync.
...
model: opus
tools: ["Read", "Write", "Glob", "Grep", "searchx", "WebSearch", "WebFetch"]
---
